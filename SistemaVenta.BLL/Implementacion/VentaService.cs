...
namespace SistemaVenta.BLL.Implementacion
{
    public class VentaService : IVentaService
    {
        ...
        public async Task<List<Venta>> Historial(string numeroVenta, string fechaInicio, string fechaFin)
        {
            ...
            {
                DateTime fecha_inicio = DateTime.ParseExact(fechaInicio, "dd/MM/yyyy", new CultureInfo("en-MX"));
        ...
        public async Task<List<Venta>> Reporte(string numeroVenta, string fechaInicio, string fechaFin)
        {
            DateTime fecha_inicio = DateTime.ParseExact(fechaInicio, "dd/MM/yyyy", new CultureInfo("en-MX"));
            DateTime fecha_fin = DateTime.ParseExact(fechaFin, "dd/MM/yyyy", new CultureInfo("en-MX"));
