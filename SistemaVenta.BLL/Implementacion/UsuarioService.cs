    ...
    public class UsuarioService : IUsuarioService
    {
        ...
        public async Task<bool> RestablecerClave(string Correo, string UrlPlantillaCorreo)
        {
            try
            {
                ...
                if (usuario_encontrado == null)
                    throw new TaskCanceledException("No se encontro usuario asociado con ese correo");
                ...
                if (htmlCorreo != "")
                    correo_enviado = await _correoService.EnviarCorreo(Correo, "Password Restablecida", htmlCorreo);

                if (!correo_enviado)
                    throw new TaskCanceledException("Tenemos problemas, intenta mas tarde");
