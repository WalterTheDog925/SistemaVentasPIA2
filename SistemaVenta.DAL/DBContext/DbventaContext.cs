...
public partial class DbventaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C3350CA89");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F24E3AFE8");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF48344FCB8B9");
        ...
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E107FA40BF8D");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547E269B0433");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A132580A40AE");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F76C6C5D09A");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D8C3C44B07");
            ...
            entity.HasOne(d => d.IdMenuNavigation).WithMany(p => p.RolMenus)
                ...
                .HasConstraintName("FK__RolMenu__idMenu__76969D2E");

            entity.HasOne(d => d.IdRolNavigation).WithMany(p => p.RolMenus)
                .HasForeignKey(d => d.IdRol)
                .HasConstraintName("FK__RolMenu__idRol__75A278F5");
        });

        modelBuilder.Entity<TipoDocumentoVenta>(entity =>
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEE0B4E2022");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A691C87644");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D5614C8C55326");
            ...
            entity.HasOne(d => d.IdTipoDocumentoVentaNavigation).WithMany(p => p.Venta)
                ...
                .HasConstraintName("FK__Venta__idTipoDoc__60A75C0F");
